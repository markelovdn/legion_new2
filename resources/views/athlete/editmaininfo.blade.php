                        ...
                        <div class="card">
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#settings" data-toggle="tab">Главная информация</a></li>
                                </ul>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="settings">
                                        <form action="/athlete/updatemaininfo" method="post" class="form-horizontal" _lpchecked="1" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">Статус</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">Фото</label>
                                                <div class="col-sm-10">
                                                    <img class="profile-user-img img-fluid img-circle" src="/uploads/{{$athlete->photo}}" alt="User profile picture">
                                                    <br>
